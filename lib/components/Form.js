...
exports.Provider = (_a = React.createContext({
    ...
    mountTransform: function () { return ({}); },
    unMountTransform: function () { return ({}); },
    ...
    function Form(props) {
        ...
        _this.handleChange = function (field, value) {
            _this.setState(function (prev) {
                ...
                var model = (_a = {}, _a[field] = value, _a);
                _this.transformers.forEach(function (transformer) {
                    model = __assign({}, model, transformer.transform(model, prevModel));
                });
                return {
