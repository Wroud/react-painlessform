    ...
    function Form(props) {
        ...
        _this.handleChange = function (field, value) {
            _this.setState(function (prev) {
                ...
                var model = _this.transformer.current.transform((_a = {}, _a[field] = value, _a), prev.model);
                return {
                    model: form_1.mergeModels(model, prev.model, function (_a, _b) {
                        var _value = _a.value;
                        var prevValue = _b.value;
                        return ({ isChanged: prevValue !== undefined && _value !== prevValue });
                    }),
                    isChanged: true,
                };
                var _a;
        ...
        _this.transformer = React.createRef();
        _this.validation = React.createRef();
        return _this;
    }
    Form.getDerivedStateFromProps = function (props, state) {
        var values = props.values, initValues = props.initValues, configure = props.configure, isChanged = props.isChanged, isSubmitting = props.isSubmitting;
