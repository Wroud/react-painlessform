...
exports.Provider = (_a = React.createContext({
    ...
    handleTransform: function () { return ({}); },
    ...
    function Form(props) {
        ...
        _this.handleChange = function (field, value) {
            _this.setState(function (prev) {
                ...
                return {
                    model: __assign({}, prev.model, (_a = {}, _a[field] = __assign({}, value), _a)),
                    isChanged: true,
                };
                var _a;
            });
        };
        _this.handleTransform = function (value) {
            _this.setState(function (prev) {
                if (shallowequal(form_1.getValuesFromModel(prev.model), form_1.getValuesFromModel(value))) {
                    return null;
                }
                return {
                    model: __assign({}, prev.model, value),
                    isChanged: true,
                };
            });
        };
        _this.state = {
            ...
            handleTransform: _this.handleTransform,
        };
        return _this;
    }
