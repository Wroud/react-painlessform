...
var Validation = /** @class */ (function (_super) {
    ...
    Validation.prototype.render = function () {
        var _this = this;
        return (React.createElement(exports.Consumer, null, function (validation) { return (React.createElement(Form_1.Consumer, null, function (context) { return React.createElement(exports.Provider, { value: validation_1.mergeValidations(_this.validate(context), validation) }, _this.props.children); })); }));
    };
