...
class Field extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(FormContext, null, formContext => (React.createElement(ValidationContext, null, ({ scope }) => {
            ...
            const errors = tools_1.fromProxy(tools_1.autoCreateProxy(formContext.storage.validation.errors), name, []);
