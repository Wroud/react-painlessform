...
var FieldClass = /** @class */ (function (_super) {
    ...
    function FieldClass() {
        ...
        _this.update = function (nextValue) {
            var _a = _this.props, handleChange = _a.form.handleChange, name = _a.name, value = _a.value, isChanged = _a.isChanged, isVisited = _a.isVisited, onChange = _a.onChange;
...
var Field = /** @class */ (function (_super) {
    ...
    Field.prototype.render = function () {
        var _this = this;
        var _a = formFactory_1.createFormFactory(), FormContext = _a.FormContext, ValidationContext = _a.ValidationContext;
        return (React.createElement(FormContext, null, function (formContext) { return (React.createElement(ValidationContext, null, function (validation) {
            ...
            if (subscribe !== undefined) {
                fullRest = __assign({}, fullRest, subscribe(formContext));
            }
            var modelValue = formContext.model[name];
