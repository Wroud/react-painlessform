...
var FieldClass = (function (_super) {
    ...
    FieldClass.prototype.shouldComponentUpdate = function (nextProps) {
        var _a = nextProps, nextErrors = _a.validationErrors, nextScope = _a.validationScope, _ = _a.formState, __ = _a.children, nextRest = __rest(_a, ["validationErrors", "validationScope", "formState", "children"]);
        var _b = this.props, validationErrors = _b.validationErrors, validationScope = _b.validationScope, formState = _b.formState, children = _b.children, rest = __rest(_b, ["validationErrors", "validationScope", "formState", "children"]);
...
var Field = (function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        return (React.createElement(Form_1.Consumer, null, function (formState) { return (React.createElement(Validation_1.Consumer, null, function (validation) {
            ...
            var _Field = Field;
            return (React.createElement(_Field, __assign({}, props, { value: value, validationErrors: validation.errors[_this.props.name], validationScope: validation.scope, formState: formState, isChanged: isChanged, isVisited: isVisited, isValid: isValid })));
        })); }));
    };
    return Field;
}(React.Component));
