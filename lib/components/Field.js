...
var Field = (function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        return (React.createElement(Form_1.Consumer, null, function (formState) { return (React.createElement(Validation_1.Consumer, null, function (validation) {
            ...
            return (React.createElement(_Field, { name: name, value: value, validationErrors: validation.errors[_this.props.name], validationScope: validation.scope, formState: formState, isChanged: isChanged, isVisited: isVisited, isValid: isValid, onClick: onClick, onChange: onChange, children: children, rest: rest }));
        })); }));
    };
    return Field;
}(React.Component));
