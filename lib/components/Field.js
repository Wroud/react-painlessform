...
var FieldClass = (function (_super) {
    ...
    FieldClass.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        var _a = this.props, onChange = _a.onChange, propsValue = _a.value;
        var _b = this.state, value = _b.value, name = _b.name, isVisited = _b.isVisited, isValid = _b.isValid, validationErrors = _b.validationErrors;
