...
var FieldClass = (function (_super) {
    ...
    FieldClass.prototype.render = function () {
        ...
        var props = __assign({}, this.props, { onChange: this.handleChange, onClick: this.onClick });
    ...
    FieldClass.prototype.shouldComponentUpdate = function (nextProps) {
        var nextErrors = nextProps.validationErrors, nextScope = nextProps.validationScope, _ = nextProps.formState, __ = nextProps.children, nextRest = __rest(nextProps, ["validationErrors", "validationScope", "formState", "children"]);
        var _a = this.props, validationErrors = _a.validationErrors, validationScope = _a.validationScope, formState = _a.formState, children = _a.children, rest = __rest(_a, ["validationErrors", "validationScope", "formState", "children"]);
...
var Field = (function (_super) {
    ...
    Field.prototype.render = function () {
        ...
        return (React.createElement(Form_1.Consumer, null, function (formState) { return (React.createElement(Validation_1.Consumer, null, function (validation) {
            var modelValue = formState.model[_this.props.name];
            var value = modelValue === undefined ? "" : modelValue.value;
            ...
            var isValid = (validation.errors[_this.props.name] === undefined
                || validation.errors[_this.props.name].length === 0)
                && (validation.scope === undefined || validation.scope.length === 0);
            return (React.createElement(FieldClass, __assign({}, _this.props, { value: value, validationErrors: validation.errors[_this.props.name], validationScope: validation.scope, formState: formState, isChanged: isChanged, isVisited: isVisited, isValid: isValid })));
        })); }));
    };
    return Field;
}(React.Component));
