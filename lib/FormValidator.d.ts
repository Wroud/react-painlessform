...
export declare function createFormValidator<TSource, TMeta = {}>(...validators: Array<IValidator<TSource, FormErrors<TSource>, TMeta> | Yup.Schema<any>>): IValidator<TSource, FormErrors<TSource>, TMeta>;
