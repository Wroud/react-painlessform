...
function concat() {
    ...
    return (function () {
        ...
        return (_a = []).concat.apply(_a, units.map(function (unit) { return unit.apply(void 0, args); }));
        var _a;
    });
}
...
function reduce() {
    ...
    return (function () {
        ...
        return units.reduce(function (prev, unit) { return (__assign({}, prev, unit.apply(void 0, args))); }, {});
    });
}
